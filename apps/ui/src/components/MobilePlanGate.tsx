...
const SETUP_SCREENS = new Set(['plans', 'checkout', 'settings', 'profile', 'developer', 'developer-unlock', 'legal', 'notice', 'confirm', 'changelog', 'updates', 'realdebrid', 'setup', 'recovery', 'system-info']);
