...
object TvmDevUnlock {
    ...
    private val expected = byteArrayOf(
        0x15, 0xad.toByte(), 0xd2.toByte(), 0x2b, 0xda.toByte(), 0x5d, 0x47, 0x9c.toByte(),
        0xb1.toByte(), 0xb3.toByte(), 0xfb.toByte(), 0x9c.toByte(), 0xaf.toByte(), 0x87.toByte(), 0x4c, 0x11,
        0x2e, 0x84.toByte(), 0xd5.toByte(), 0x89.toByte(), 0x58, 0x21, 0x64, 0x62,
        0x4b, 0x89.toByte(), 0xd0.toByte(), 0x0c, 0xa7.toByte(), 0x9e.toByte(), 0x22, 0xa7.toByte(),
    )
