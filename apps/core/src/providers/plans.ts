...
export const STYLE_CATALOG: readonly StyleSpec[] = [
  ...
  { id: 'ocean', name: 'Ocean', minPlan: 'free' },
  { id: 'ice', name: 'Ice', minPlan: 'free' },
  ...
  { id: 'rose', name: 'Rose', minPlan: 'free' },
  { id: 'violet', name: 'Violet', minPlan: 'free' },
  { id: 'sand', name: 'Sand', minPlan: 'free' },
  { id: 'copper', name: 'Copper', minPlan: 'free' },
  { id: 'gold', name: 'MAX Gold', minPlan: 'free' },
  { id: 'aurora', name: 'Aurora', minPlan: 'free' },
  { id: 'eagles', name: 'Eagles', minPlan: 'free' },
  { id: 'crimson', name: 'Crimson', minPlan: 'free' },
  { id: 'royal', name: 'Royal', minPlan: 'free' },
  { id: 'sunset', name: 'Sunset', minPlan: 'free' },
  { id: 'neon', name: 'Neon', minPlan: 'free' },
  { id: 'graphite', name: 'Graphite', minPlan: 'free' },
];
...
export const PLAN_CATALOG: readonly PlanDefinition[] = [
  {
    ...
    profilesMax: 1,
    skipRecap: false,
    extras: ['TVM Stream only', 'Shared Real-Debrid pool when you add it', 'Ads do not use watch hours', 'Every colour style'],
    badges: [],
  },
  {
    id: 'basic',
  ...
  },
  {
    ...
    profilesMax: 4,
    skipRecap: false,
    extras: ['No ads', 'No queue', 'Every colour style', 'Four profiles'],
    badges: [],
  },
  {
    id: 'ultra',
